...
> = {
  es: {
    ...
    filterCurrency: "Moneda del precio",
...
> = {
  es: {
    ...
    descriptionFallback:
      "Para más detalle y disponibilidad actual, escríbenos o agenda una visita con un asesor YOU.",
    virtualTourCta: "Tour virtual",
    ...
    bookingSectionHint:
      "Elige primero el día, luego la hora en punto y, al final, documentación y tus datos. La visita queda como solicitud hasta que el equipo la confirme por correo.",
    ...
    bookingUnavailableAdvisorEmail:
      "Falta el correo del asesor en la configuración del equipo. Mientras tanto, contáctanos por WhatsApp.",
    ...
    bookingUnavailableNoEncryption:
      "La solicitud de visitas no está configurada en el servidor por falta de cifrado de documentación. Contacta al equipo técnico o usa WhatsApp.",
    ...
    bookingDocIne: "Identificación oficial vigente — INE o pasaporte",
    ...
    bookingDocNotesLabel: "Notas adicionales opcionales",
  ...
  en: {
    ...
    bookingSectionHint:
      "Pick a day, then a time on the hour, then documentation and your details. Your visit stays a request until we confirm it by email.",
    ...
    bookingPhoneLabel: "Optional phone",
    ...
    bookingUnavailableAdvisorEmail:
      "The advisor email isn’t configured in admin yet for your team. Please use WhatsApp for now.",
    ...
    bookingUnavailableNoEncryption:
      "Visit requests aren’t configured on the server because document encryption is missing. Contact us or use WhatsApp.",
